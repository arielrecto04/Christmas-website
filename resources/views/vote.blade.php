                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex gap-2 justify-center">
                                                    ...
                                                    <dialog id="ranking_modal_{{ $survey->id }}" class="modal"
                                                        x-data="rankingData()">
                                                    ...
                                                    @else
                                                    <button {{ !$survey->is_active ? 'disabled' : '' }}
                                                        class="btn"
                                                    ...
                                                    <dialog x-data x-ref="voteModal" id="vote_modal_{{ $survey->id }}"
                                                        ...
                                                        <div class="modal-box max-w-[800px]">
                                                            ...
                                                            <div
                                                                class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 grid-flow-row gap-2">
